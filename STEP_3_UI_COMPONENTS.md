...
### 1.1 Enhanced MainLayout

**File:** `PgmqAdminUI/Components/Layout/MainLayout.razor`

**Current State:** Minimal layout with just `@Body`
...
- Status indicator showing Postgres connection state
...
- `HttpClient` (for health checks if needed)

---

### 1.2 Status Indicator Component

**File:** `PgmqAdminUI/Components/UI/StatusIndicator.razor`

**Purpose:** Display real-time Postgres connection status
...
- Visual badge (green=online, gray=offline)
- Tooltip shows last check time
- Automatic disposal of timer

---

### 1.3 Notification System

**File:** `PgmqAdminUI/Components/UI/NotificationService.cs`
...
**File:** `PgmqAdminUI/Components/UI/NotificationContainer.razor`
