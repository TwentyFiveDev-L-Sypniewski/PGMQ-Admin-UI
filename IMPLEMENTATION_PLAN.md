...
│  ├─ pgmq.q_* (queue tables)         │
│  ├─ pgmq.a_* (archive tables)       │
│  └─ PGMQ Functions                  │
└─────────────────────────────────────┘
...
ENV ConnectionStrings__Pgmq="Host=postgres;Port=5432;Database=postgres;Username=pgmq_admin;Password=secure_password"
...
services:
  ...
  pgmq-ui:
    ...
    depends_on:
      - postgres
    environment:
      ConnectionStrings__Pgmq: "Host=postgres;Port=5432;Database=postgres;Username=pgmq_admin;Password=secure_password"
